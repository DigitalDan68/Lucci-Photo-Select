...
contextBridge.exposeInMainWorld('photoAPI',{
  ...
  platform:process.platform,loadLibrary:()=>ipcRenderer.invoke('library:load'),importCard:()=>ipcRenderer.invoke('library:import'),importFolder:()=>ipcRenderer.invoke('library:import-folder'),
