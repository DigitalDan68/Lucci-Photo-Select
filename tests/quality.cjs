...
test('missing subject detection marks review without forcing a good photo to rank poorly',()=>{const result=assessQuality(1,1,0,false);assert.equal(result.score,4.25);assert.equal(result.review,true)})
